...
public class SecondStageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView.setText(extras.getString(Helper.USER_NAME));
    ...
    private void showStartupDialog() {
        AlertDialog alertDialog = new AlertDialog.Builder(SecondStageActivity.this).create();
        alertDialog.setTitle("Password");
        alertDialog.setCancelable(false);
        alertDialog.setMessage("Zvol aspon 6-ciferne heslo");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(SecondStageActivity.this, TrainActivity.class);
